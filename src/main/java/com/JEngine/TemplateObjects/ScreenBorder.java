...
public class ScreenBorder {
    ...
    void createWalls(Vector3 basePos){
        ...
        wall1.setCollider(new BoxCollider(Transform.simpleTransform(basePos), new JIdentity("ScreenBorderWallTop", "border"),
        ...
        wall2.setCollider(new BoxCollider(wall2.getTransform(), new JIdentity("ScreenBorderWallBottom", "border"),
                (int)(1280* SceneManager.getWindow().getScaleMultiplier()),
                1, wall2, false));
        ...
        wall3.setCollider(new BoxCollider(wall3.getTransform(), new JIdentity("ScreenBorderWallRight", "border"),
                1,
        ...
        wall4.setCollider(new BoxCollider(wall4.getTransform(), new JIdentity("ScreenBorderWallLeft", "border"),
                1,
